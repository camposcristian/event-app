...
angular.module('ngCordova.plugins.calendar', [])
  ...
  .factory('$cordovaCalendar', [function () {

    return {
      createEvent: function (title,location,notes,startDate,endDate, success, fail) {
        return window.plugins.calendar.createEvent(title,location,notes,startDate,endDate,success,fail);
      }
    }
  }]);
